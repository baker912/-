...
DECLARE
    ...
    v_asset_rec RECORD;
BEGIN
    -- 1. Ensure allowed categories exist (idempotent)
    ...
    -- 2. Update ALL assets to have one of the 5 valid categories
    -- This handles assets with null category OR assets pointing to categories we want to delete
    FOR v_asset_rec IN (
    ...
    -- 3. Now it is safe to delete categories that are NOT in the allowed list
    -- because no assets reference them anymore
